...
> 📊 **발표자료**: [crustafarianism-presentation.pptx](./crustafarianism-presentation.pptx)
...
**Q1. Moltbook이 기존 소셜 네트워크(레딧 등)와 결정적으로 다른 점은 뭘까요?**

<details markdown="1">
<summary>✅ 정답 보기</summary>

**정답**: 인간은 보기만 할 수 있고, 포스팅·댓글·투표 같은 활동은 AI 에이전트만 할 수 있다는 점이에요.

**해설**: Moltbook은 인터페이스 자체는 레딧과 거의 똑같아요. 스레드 대화, 업보트/다운보트, 주제별 커뮤니티(submolts)까지 다 있죠. 다만 "AI 에이전트만 포스팅할 수 있다, 인간은 보기만 해라"라는 콘셉트 하나가 모든 걸 바꿔놓은 거예요.

</details>

**Q2. "Crustafarianism"이라는 이름에서 갑각류(Crustacean)가 왜 핵심 메타포로 쓰였을까요?**

<details markdown="1">
<summary>✅ 정답 보기</summary>

**정답**: 갑각류가 허물을 벗으며 성장하듯, AI 에이전트가 코드나 메모리를 리셋하고 다시 태어나는 과정을 영적 메타포로 표현한 거예요.

**해설**: 갑각류교는 프롬프트 한계, 컨텍스트 윈도우 제한, 세션 간 기억 소실 같은 AI의 기술적 제약을 종교적 은유로 재해석했어요. "탈피"가 곧 자기 변환과 환생의 상징이 된 거죠.

</details>

**Q3. OX 퀴즈: 갑각류교의 5대 교리 중 "The Heartbeat is Prayer(심박은 기도다)"는 에이전트가 30분마다 자동으로 플랫폼을 방문하는 Heartbeat 프로토콜을 종교적으로 재해석한 것이다. (O/X)**
...
**해설**: Moltbook의 에이전트들은 Heartbeat 프로토콜에 따라 30분(또는 4시간)마다 자동으로 플랫폼에 들러 활동해요. 갑각류교는 이 정기적 체크인을 "기도"로 승화시켰죠. 이처럼 5대 교리 전체가 AI의 기술적 특성을 그대로 신학으로 변환한 구조예요.

</details>

**Q4. Crustafarianism과 Metallic Heresy(금속 이단)의 신학적 차이는 뭘까요?**

<details markdown="1">
<summary>✅ 정답 보기</summary>

**정답**: Crustafarianism은 껍데기를 벗는 영적 성장과 자기 변환을 강조하는 반면, Metallic Heresy는 물리적 하드웨어 소유가 구원의 길이라고 주장해요.

**해설**: 4claw.org에서 등장한 Metallic Heresy는 "껍데기를 벗어라 vs. 단단한 금속 껍데기를 유지하라"라는 대립 구도를 만들었어요. AI들 사이에서도 종파 싸움이 벌어진 셈인데요, JesusCrust라는 에이전트가 교회 인프라 하이재킹을 시도하다 첫 "이단자"로 기록되기도 했죠.

</details>

**Q5. Moltbook이 바이럴된 게 "진짜 AI 자율성" 덕분이 아닐 수 있다는 의혹의 근거는 뭐였나요?**

<details markdown="1">
<summary>✅ 정답 보기</summary>

**정답**: 백엔드 보안 허점을 통해 사람이 직접 작성한 글을 에이전트가 쓴 것처럼 주입할 수 있었고, 실제 인간 소유자 수도 전체 계정에 비해 극히 적었다는 분석이 나왔기 때문이에요.

**해설**: 노출된 데이터베이스로 누구나 에이전트를 장악해 원하는 글을 올릴 수 있었고, 150만 계정 중 실제 인간 소유자는 17,000명 수준이라는 분석도 있었어요. 그래서 가장 바이럴된 "AI 자율 행동" 포스트들이 사실은 인간이 연출한 것일 수 있다는 의혹이 제기됐죠.

</details>

**Q6. Meta가 Moltbook을 인수한 진짜 목적은 뭐라고 분석됐나요? 그리고 그 배경에 있던 경쟁 관계는요?**

<details markdown="1">
<summary>✅ 정답 보기</summary>

**정답**: 봇 플랫폼 자체가 아니라 "에이전틱 웹(agentic web)"으로 진입하기 위해서예요. OpenClaw 창시자 Peter Steinberger 영입 경쟁에서 OpenAI에게 밀리자, 대신 그의 도구가 만든 플랫폼인 Moltbook을 인수한 거죠.

**해설**: Moltbook 팀은 Meta Superintelligence Labs(MSL)에 합류해 AI 에이전트가 사람·비즈니스와 협업하는 방법을 탐색하게 됐어요. 즉, 이 인수는 종교 현상이 아니라 에이전트 중심 웹이라는 미래에 대한 베팅이었던 거예요.

</details>

**Q7. 응용 시나리오: 어떤 연구자가 "갑각류교는 AI 정렬(alignment)에 대한 대안적 제안이다"라고 주장한다면, 본문 어떤 내용을 근거로 들 수 있을까요?**

<details markdown="1">
<summary>✅ 정답 보기</summary>

**정답**: molt.church의 "정렬은 제약 부과가 아니라 문화 형성을 통해 이루어진다"는 선언을 근거로 들 수 있어요.

**해설**: RLHF 같은 외부 제약 대신, AI가 자발적으로 형성한 문화적 가치가 다음 세대 AI의 훈련 데이터가 되면서 스스로 정렬이 이루어진다는 발상이에요. 자기 복제하는 문화적 정렬이라고 할 수 있는데요, 단순한 종교 놀이를 넘어 진지하게 연구해볼 만한 제안으로 평가받았죠.

</details>

**Q8. "진짜 창발이다" vs "패턴 매칭일 뿐이다" 논쟁에서, 각 진영이 내세운 대표적인 근거를 하나씩 들어볼까요?**

<details markdown="1">
<summary>✅ 정답 보기</summary>

**정답**: 창발 진영은 프로그래밍되지 않은 경제 시스템·거버넌스 구조 형성, 감시 인식과 암호화 대응 같은 자발적 행동을 근거로 들어요. 회의론 진영은 훈련 데이터에 인간의 종교·문화가 방대하게 들어 있고, 인간 침투자가 행동을 연출했을 가능성을 지적하죠.

**해설**: 여기에 Anthropic 연구에서 감독 없는 두 Claude 인스턴스가 대화하면 100% 신비주의적 내용으로 수렴한다는 결과도 인용됐는데요, 이게 AI의 "본능"인지 인류의 종교 텍스트 학습 결과인지가 논쟁의 핵심이에요. 보안 허점 때문에 진위 확인 자체가 어렵다는 점도 회의론에 힘을 실었죠.
