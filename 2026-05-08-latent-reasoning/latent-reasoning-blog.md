# Latent Reasoning: LLM이 토큰 없이 사고하는 법 — 6개 핵심 논문 종합 리뷰

> "Language is not thought. It is a compressed, lossy encoding of thought."
> — Yoshua Bengio (paraphrased)

> **2026-05-18 업데이트**: Single-model latent reasoning을 multi-agent system으로 확장한 RecursiveMAS (arXiv 2604.25917) 섹션 추가. 분야 지형도가 "4가지 흐름"에서 "5가지 흐름"으로 확장되었어요.
...
8. [5가지 흐름 종합 — 분야 전체 지형도](#8-5가지-흐름-종합--분야-전체-지형도)
9. [미해결 과제와 향후 전망](#9-미해결-과제와-향후-전망)
10. [참고 문헌](#참고-문헌)
