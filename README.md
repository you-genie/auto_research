...
| 날짜 | 주제 | 산출물 |
|------|------|--------|
| 2026-07-24 | [요즘 에이전트, 진짜로 뭘로 만들어지나 — '가장 복잡한 에이전트'를 상정한 구성요소 전면 해부 (하네스/컨텍스트 엔지니어링/MCP/스킬/메모리/플래닝/멀티에이전트/평가·가드레일/상용 스택)](2026-07-24-agent-architecture/) | 블로그, PPT, 참고문헌 |
...
| 날짜 | 주제 | 산출물 |
|------|------|--------|
| 2026-07-24 | [이미지·비디오 생성의 Consistency 완전 정복 (DreamBooth·IP-Adapter·ConsiStory / AnimateDiff·Sora·DiT / Consistency Models 구분)](2026-07-24-image-video-consistency/) | 블로그, 참고문헌 |

### Development

| 날짜 | 주제 | 산출물 |
|------|------|--------|
| 2026-07-15 | [Svelte 가이드 101: 온보딩 클래스 (Svelte 5 Runes/컴포넌트/SvelteKit 라우팅/데이터 로딩)](2026-07-15-svelte-guide-101/) | 블로그, PPT, 참고문헌 |
| 2026-07-15 | [피그마 가이드 101: 온보딩 클래스 (인터페이스/Auto Layout/컴포넌트/변수/프로토타입/Dev Mode)](2026-07-15-figma-guide-101/) | 블로그, PPT, 참고문헌 |
| 2026-07-15 | [프론트엔드 프레임워크 비교 & 개발 가이드 (React/Vue/Angular/Svelte + 주의점 + 코드 스타일)](2026-07-15-fe-framework-guide/) | 블로그, PPT, 참고문헌 |
